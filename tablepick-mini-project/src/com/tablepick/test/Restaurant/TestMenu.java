...
public class TestMenu{
	...
	public static void main(String[] args) {
		...
		while (create) {
			...
			System.out.println("1. 메뉴 조회하기 2. 메뉴 생성하기 3. 이전 화면으로 돌아가기 4. 프로그램 종료하기");
			console = sc.nextLine();
			...
			case "2":
				...
				price = sc.nextInt();
				sc.nextLine();
				System.out.println("등록하려는 메뉴입니다. [" + menu + " : " + price + "]");
				...
				if (yesOrNo.equals("예")) {
					...
					try {
						dao.createMenu(new MenuVO(restaurantId, menu, price));
